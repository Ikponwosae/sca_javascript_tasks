...
const runners = [
  ...
  runners.forEach(myFunction);
   ...
   function myFunction(object,index,array){
    var x = object.first_name + " " + object.last_name;
     fullNames.push(x);
}
...
console.log(fullNames);
  ...
  var firstNamesAllCaps = [];

  runners.map(meFunction);

   function meFunction(object,index,array){

    var l = object.first_name.toUpperCase();
    firstNamesAllCaps.push(l);
}
...
console.log(firstNamesAllCaps);
 ...
 var runnersLargeSizeShirt = [];

 var sizes = runners.filter(miFunction);

  function miFunction(object,index,array){
    var s = object.shirt_size;
    var k = object.first_name;

    if(s == "L"){
//console.log(object.first_name);
   runnersLargeSizeShirt.push(k);
  }
}
...
console.log(runnersLargeSizeShirt);
 ...
 runners.map(misFunction);

  function misFunction(object,index,array){
   var s = object.donation;
   sum.push(s);
}

 var ticketPriceTotal = sum.reduce(sumFunction, 0);
